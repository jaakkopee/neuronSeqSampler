...
\section{BeatRoot Multi-Agent Beat Tracking}

\subsection{Agent-Based Architecture}

The BeatRoot system employs multiple competing agents, each representing a distinct tempo and phase hypothesis. This multi-agent approach provides robust beat tracking in complex musical scenarios where single-hypothesis trackers fail.
